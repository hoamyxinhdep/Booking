                ...
                <form action="MainController" method="POST">
                    <div class="user-details">
                        ...
                        <div class="input-box form-label">
                            ...
                            <input type="text" placeholder="Enter your password" name="Password" class="form-control" id="exampleInputPassword1"required>
                            <p style="color: red">${requestScope.USER_ERROR.getPasswordError()}</p>
                        </div>
                        <div class="input-box">
                            <span class="details">Confirm Password</span>
                            <input type="text" placeholder="Confirm your password"name="rePassword" class="form-control" id="exampleInputPassword1" required>
